...
# --- Append this to myeasymocap/dataset/config.py ---
...
CONFIG['coco133'] = {
    'nJoints': 133,
    'kintree': [
        # === BODY (Standard 17 COCO) ===
        # Center (Black)
        (0, 1), (0, 2), # Nose -> Eyes
        (1, 3), (2, 4), # Eyes -> Ears
        # Shoulders & Hips (Black/Center)
        (5, 6),   # L-Shoulder to R-Shoulder
        (11, 12), # L-Hip to R-Hip
        (5, 11),  # L-Shoulder to L-Hip (Torso Left)
        (6, 12),  # R-Shoulder to R-Hip (Torso Right)
        ...
        # === FEET (6 points) ===
        # Left Foot (Blue): Ankle(15) -> BigToe(17), SmallToe(18), Heel(19)
        (15, 17), (15, 18), (15, 19), 
        # Right Foot (Red): Ankle(16) -> BigToe(20), SmallToe(21), Heel(22)
        (16, 20), (16, 21), (16, 22),
        ...
        (78, 79), (79, 80), (80, 81), (81, 82), (82, 71),
        (83, 84), (84, 85), (85, 86), (86, 87), (87, 88), (88, 89), (89, 90), (90, 83),

        # === LEFT HAND (21 points) ===
        # Connect Left Wrist (9) to Hand Root (91)
        (9, 91),
        ...
        # Connect Right Wrist (10) to Hand Root (112)
        (10, 112),
    ...
    # Color Logic: Right=Red('r'), Left=Blue('b'), Center=Black('k')
    'colors': [
        # --- Body (18 lines) ---
        'k', 'k',           # Nose->Eyes
        'k', 'k',           # Eyes->Ears
        'k', 'k',           # Shoulders/Hips connection
        'b', 'r',           # Torso sides (L/R)
        'b', 'b',           # Left Arm
        'r', 'r',           # Right Arm
        'b', 'b',           # Left Leg
        ...
        # --- Feet (6 lines) ---
        'b', 'b', 'b',      # Left Foot (Blue)
        'r', 'r', 'r',      # Right Foot (Red)

        # --- Face (68 lines) ---
        # Face usually uses 'k' (black) or 'white' to keep it neutral
        ...
        # --- Left Hand (21 lines) ---
        # Using colors from CONFIG['hand']['colors']
        'b', # Wrist connect
        '_k', '_k', '_k', '_k', '_r', '_r', '_r', '_r', 
        '_g', '_g', '_g', '_g', '_b', '_b', '_b', '_b', 
        '_y', '_y', '_y', '_y', 
        ...
        # --- Right Hand (21 lines) ---
        # Using colors from CONFIG['hand']['colorsrhand']
        'r', # Wrist connect
        '_pink', '_pink', '_pink', '_pink', '_mint', '_mint', '_mint', '_mint', 
        '_orange', '_orange', '_orange', '_orange', '_mint2', '_mint2', '_mint2', '_mint2', 
        'purple', 'purple', 'purple', 'purple'
